...
class QuotesSpider(scrapy.Spider):
    ...
    def parse_author(self, response):
        ...
        # Отримуємо дані про цитату та автора з метаданих запиту
